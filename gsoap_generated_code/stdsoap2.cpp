...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.3.8 2003-09-20 12:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.3.8 2003-09-20 12:00:00 GMT")
#endif
...
{ ssl_init();
  ...
  if (soap->cafile)
    if (!SSL_CTX_load_verify_locations(soap->ctx, soap->cafile, NULL)
